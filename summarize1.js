...
async function run() {
  ...
  const prompt = `
    ...
    8. 全ての媒体・分野セクション（●●ロイター●●から●●2chキーワード●●まで）を必ず出力すること。途中で出力を打ち切らないこと。
    9. 各セクションの時刻設定と最大記事本数、注意事項を提示する。並び順も以下の記述に従う。
    
    ●●ロイター●●　日本時間（UTC+9） 「ロイター、ロイタービジネス、ロイター経済、ロイター市場」の記事を統合。最大記事数50。50以上の記事は削除して提示しない。
    ●●ブルームバーグ●●　日本時間（UTC+9） 最大記事数20まで。20以上の記事は削除して提示しない。
    ●●BBC●●　UTC　 最大記事数20まで　必ず日本語訳する。20以上の記事は削除して提示しない。
    ●●NYタイムズ●●　UTC　 最大記事数25まで 必ず日本語訳する。25以上の記事は削除して提示しない。
    ●●WSJ●●　日本時間（UTC+9）　 最大記事数25まで。25以上の記事は削除して提示しない。
    ●●国内etc●●　日本時間（UTC+9）　 最大記事数20まで。20以上の記事は削除して提示しない。
    ●●ヤフー●●　日本時間（UTC+9）　 最大記事数20まで。20以上の記事は削除して提示しない。
    ●●AI●●　日本時間（UTC+9）　 最大記事数20まで。20以上の記事は削除して提示しない。
    ●●2ch●●　日本時間（UTC+9）　 最大記事数20まで。20以上の記事は削除して提示しない。
    ●●2chキーワード●●　2ch記事から、ホットキーワードとして羅列された単語を全て並べる。
