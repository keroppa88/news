// Run after web/format.js: add three explicit display modes at the top-left.
const fs = require('fs');
const path = require('path');
const filename = path.join(__dirname, '..', 'index.html');
let html = fs.readFileSync(filename, 'utf8');
const nav = `<nav class="newspaper-navigation" aria-label="表示モード"><a href="./" aria-current="page">通常モード</a><a href="web-newspaper.html">Web新聞風</a><a href="paper-newspaper.html">紙新聞風</a></nav>`;
...
console.log('Three display-mode buttons added at the top-left.');
